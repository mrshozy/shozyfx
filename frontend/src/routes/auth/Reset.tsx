...
const Reset: React.FC<ResetProps> = () => {
  ...
  if (token) {
    return (
      <div className={'h-full w-full flex justify-center flex-col items-center'}>
        <div className='container max-w-[400px] space-y-4 h-full flex-col items-center mt-28 justify-start '>
          ...
          <Typography variant={'p'} muted className={'text-center'}>
            Please enter the new password associated with your account to reset the password of your account.
          </Typography>
  ...
  return (
    <div className={'h-full w-full flex justify-center flex-col items-center'}>
      <div
        className='container max-w-[400px]  space-y-4 flex h-full flex-col items-center mt-28 justify-start'>
        <img width={80} className={'w-24 h-24'} src={'/password-reset.png'} alt={'lock'} />
