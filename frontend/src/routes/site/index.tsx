...
const Home: React.FC<HomeProps> = () => {
  ...
  return (
    <Layout social showNavBar className={'flex flex-col items-center space-y-10 sm:pt-3 md:pt-6 lg:pt-10'}>
      <div
      ...
      <Link href={authenticated ? '/dashboard' : '/auth/register'}
            className={buttonVariants()}>{authenticated ? 'Visit Dashboard' : 'Get Started'}</Link>
