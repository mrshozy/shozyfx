...
export const Site: React.FC<SiteProps> = ({ children, className }) => {
        ...
        <div className={'w-full h-full flex flex-row justify-start items-center px-3 space-x-3'}>
          ...
          <div className={'fixed right-3 flex flex-row justify-start items-center space-x-3'}>
            ...
            <Sheet>
              ...
              <SheetContent side={'left'} className={'flex flex-col justify-start focus:border-none'}>
                <SheetHeader className={'w-full flex flex-row text-center space-x-2 justify-start items-start'}>
