...
export function SelectorView({title, options, constant, onChange, selected, className}: DataTableFacetedFilterProps) {
    return (
        <Popover>
                                    ...
                                    <CommandItem
                                        ...
                                        onSelect={() => {
                                            async function filterData() {
                                                ...
                                                if (!isSelected) {
                                                    s = constant.find(p => p.toLowerCase() == option.label.toLowerCase())
                                                }
                                                onChange(s)
                                            }
